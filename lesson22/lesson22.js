...
if (amount >= 200 && amount < 300) {
    alert (`До оплати ${amount - (amount * .03)} грн. Ваша знижка 3% (${amount * .03} грн)`);
} else if (amount >= 300 && amount < 500) {
    alert (`До оплати ${amount - (amount * .05)} грн. Ваша знижка 5% (${amount * .05} грн)`);
} else if (amount >= 500) {
    alert (`До оплати ${amount - (amount * .07)} грн. Ваша знижка 7% (${amount * .07} грн)`);
} else {
